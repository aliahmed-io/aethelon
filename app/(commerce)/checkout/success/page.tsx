        ...
        <div className="bg-background min-h-screen text-foreground flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-lg mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                    <Link href="/tracking" className="w-full md:w-auto px-8 py-3 bg-muted border border-border hover:bg-accent/10 transition-colors text-xs font-bold uppercase tracking-widest rounded-sm">
                        Track an Order
                    </Link>
