...
export default function AdminCOOPage() {
    return (
                    ...
                    {[
                        ...
                        <div key={kpi.label} className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className={`text-xs font-semibold px-2 py-1 rounded-full ${kpi.change.includes('+') ? 'bg-emerald-50 text-emerald-600' : 'bg-slate-100 text-slate-600'}`}>
                                    {kpi.change}
                                </span>
                            </div>
