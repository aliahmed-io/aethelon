    ...
    const stories = [
        {
            year: "1936",
            title: "THE ORIGIN",
            desc: "Aethelon creates the first specialized Aviator's Instrument, defining a new standard for flight precision.",
            image: "/assets/heritage/history-1936.jpg"
        },
        {
            year: "1940",
            title: "BIG PILOT",
            desc: "The 52 T.S.C. becomes the largest wristwatch ever produced by Aethelon, featuring a central hacking seconds.",
            image: "/assets/heritage/history-1940.avif"
        },
        {
            year: "1948",
            title: "MARK 11",
            desc: "Commissioned for the Royal Air Force, the Mark 11 establishes Aethelon as the master of magnetic resistance.",
            image: "/assets/heritage/history-1948.webp"
        },
        {
            year: "2007",
            title: "CHRONO ERA",
            desc: "The introduction of the Double Chronograph splits seconds and defines the modern Aethelon aesthetic.",
