...
const links = [
    ...
    { name: "Returns", href: "/dashboard/returns", icon: Receipt },
    ...
    return (
        <>
            ...
            <div className={cn(
                ...
                <div className="h-16 hidden md:flex shrink-0 items-center justify-between px-6 border-b border-border w-full relative z-10 bg-muted/50 backdrop-blur-xl">
                    <h1 className="text-xl font-bold tracking-tighter uppercase text-foreground">Aethelon<span className="text-accent text-xs ml-1 font-normal tracking-widest">ADMIN</span></h1>
                    <Link
                        href="/"
